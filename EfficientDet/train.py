...
if __name__ == "__main__":
    ...
    train_annotation_path = '/mnt/disk1/data0/jxt/classification/faster-rcnn-pytorch-master/number_train_data_10.txt'
    val_annotation_path = '/mnt/disk1/data0/jxt/classification/faster-rcnn-pytorch-master/number_val_data_10.txt'
    ...
    #   获得损失函数
    #----------------------#
    # # 假设有20个类别，每个类别的样本数量分别是100, 200, 100, ...
    # class_counts = torch.tensor([459, 849, 813, 97, 67, 75, 69, 159, 118, 386, 53, 813, 193, 565, 23, 83, 55, 89, 27, 132], dtype=torch.float32)
    #
    # 计算每个类别的权值
    ...
    class_weights = torch.tensor([0.020732, 0.236168, 0.873733, 0.269372, 0.792456, 1.252122, 5.612452, 0.512966, 0.346699, 0.083300])
    ...
    if True:
        ...
        train_dataset   = EfficientdetDataset(train_lines, input_shape, num_classes, train = False)
