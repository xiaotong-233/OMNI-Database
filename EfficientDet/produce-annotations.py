...
# 生成保存数据路径和标注信息的txt文件
train_data_info_file = "number_train_data.txt"
val_data_info_file = "number_val_data.txt"
test_data_info_file = "number_test_data.txt"
        ...
        for subfolder in os.listdir(annotation_folder_path):
            ...
            for file in os.listdir(subfolder_path):
                ...
                for obj in root.findall("object"):
                    ...
                    xmax = bbox.find("xmax").text
                    ymax = bbox.find("ymax").text
                    category = int(obj.find("name").text)
                    annotation_info += f"{xmin},{ymin},{xmax},{ymax},{category} "
