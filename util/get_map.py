...
if __name__ == "__main__":
    ...
    #   默认指向根目录下的VOC数据集
    # -------------------------------------------------------#
    dataset_path = '/mnt/disk1/data0/jxt/dataset/data/frontandside'
    # -------------------------------------------------------#
    #   结果输出的文件夹，默认为map_out
    # -------------------------------------------------------#
    map_out_path = 'map_out'

    image_ids = open(os.path.join(dataset_path, "imageset1/test.txt")).read().strip().split()
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        for folders_name in tqdm(image_ids):
            folders_path = os.path.join(dataset_path, "JPEGImages", folders_name)
