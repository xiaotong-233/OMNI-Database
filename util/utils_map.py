...
# def preprocess_dr(dr_path, class_names):
#     results = []
#     with open(os.path.join(dr_path, "ImageSets", "train.txt")) as train_file:
#         train_ids = train_file.read().splitlines()
#     with open(os.path.join(dr_path, "ImageSets", "test.txt")) as test_file:
#         test_ids = test_file.read().splitlines()
#     with open(os.path.join(dr_path, "ImageSets", "val.txt")) as val_file:
